export default [
  { path: '/user', layout: false, routes: [{ path: '/user/login', name:"管理3", component: './User/Login' }] },
  { path: '/', redirect: '/add_chart'},
  { path: '/add_chart',name: "Create Chart", icon: 'barChart', component: './AddChart' },
  { path: '/add_chart_async',name: "Create Chart (Async)", icon: 'barChart', component: './AddChartAsync' },
