        ...
        <Col span={12}>
          <Card title={"AIGC BI"}>
            ...
            >
              ...
              <Form.Item name="goal" label="Analyze Goal" rules={[{ required: true, message: 'Please input your request!' }]}>
                <TextArea placeholder={"Input your request. For example: Analyze website user growth"}/>
              </Form.Item>
